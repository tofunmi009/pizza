...
$result = mysqli_query($mysqli, "SELECT * FROM delivery ORDER BY id DESC");
?>
...
<a href="add.php" id="new">Add New User</a><br/><br/>
    ...
    <tr>
    <th>id</th>
           <th>name</th> <th>number</th> <th>email</th> <th>street</th> <th>apt</th>    
    ...
    while($complaint_data = mysqli_fetch_array($result)) {
        ...
        echo "<td>".$complaint_data['street']."</td>";
        echo "<td>".$complaint_data['apt']."</td>";
        echo "<td>".$complaint_data['city']."</td>";
        echo "<td>".$complaint_data['state']."</td>";
        echo "<td>".$complaint_data['zip']."</td>";
